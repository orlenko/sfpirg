...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsPost.featured_image'
        db.add_column(u'news_newspost', 'featured_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsPost.featured_image'
        db.delete_column(u'news_newspost', 'featured_image')
