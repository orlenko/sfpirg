...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsPost.image'
        db.delete_column(u'news_newspost', 'image')


    def backwards(self, orm):
        # Adding field 'NewsPost.image'
        db.add_column(u'news_newspost', 'image',
    ...
    models = {
        ...
        u'news.newspost': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'NewsPost', '_ormbases': [u'pages.Page']},
