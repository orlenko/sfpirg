...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsPost.featured_image_wide'
        db.add_column(u'news_newspost', 'featured_image_wide',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsPost.marquee_caption'
        db.add_column(u'news_newspost', 'marquee_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsPost.featured_image_wide'
        db.delete_column(u'news_newspost', 'featured_image_wide')

        # Deleting field 'NewsPost.marquee_caption'
        db.delete_column(u'news_newspost', 'marquee_caption')
    ...
    models = {
        ...
        u'news.newspost': {
            ...
            'featured_image_wide': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'marquee_caption': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
