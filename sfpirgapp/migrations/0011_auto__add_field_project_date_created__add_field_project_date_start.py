...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sfpirgapp_project', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 19, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Project.date_start'
        db.add_column(u'sfpirgapp_project', 'date_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.date_created'
        db.delete_column(u'sfpirgapp_project', 'date_created')

        # Deleting field 'Project.date_start'
        db.delete_column(u'sfpirgapp_project', 'date_start')
