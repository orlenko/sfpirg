...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.admin_notes'
        db.add_column(u'sfpirgapp_project', 'admin_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.admin_notes'
        db.delete_column(u'sfpirgapp_project', 'admin_notes')
