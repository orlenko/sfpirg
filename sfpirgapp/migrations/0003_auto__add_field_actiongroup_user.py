...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionGroup.user'
        db.add_column(u'sfpirgapp_actiongroup', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='actiongroups', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionGroup.user'
        db.delete_column(u'sfpirgapp_actiongroup', 'user_id')
