...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.is_finished'
        db.add_column(u'sfpirgapp_project', 'is_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.is_completed_successfully'
        db.add_column(u'sfpirgapp_project', 'is_completed_successfully',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.is_underway'
        db.delete_column(u'sfpirgapp_project', 'is_underway')

        # Deleting field 'Project.is_finished'
        db.delete_column(u'sfpirgapp_project', 'is_finished')

        # Deleting field 'Project.is_completed_successfully'
        db.delete_column(u'sfpirgapp_project', 'is_completed_successfully')
