...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sfpirgapp_profile', 'photo', self.gf('sfpirgapp.fields.MyImageField')(max_length=255, null=True))
        # Deleting field 'Project.is_published'
        db.delete_column(u'sfpirgapp_project', 'is_published')
        ...
        db.add_column(u'sfpirgapp_project', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Project.logo'
        db.alter_column(u'sfpirgapp_project', 'logo', self.gf('sfpirgapp.fields.MyImageField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.photo'
        db.alter_column(u'sfpirgapp_profile', 'photo', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))
        # Adding field 'Project.is_published'
        db.add_column(u'sfpirgapp_project', 'is_published',
        ...
        db.delete_column(u'sfpirgapp_project', 'is_approved')


        # Changing field 'Project.logo'
        db.alter_column(u'sfpirgapp_project', 'logo', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))
