...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.project_subject_other'
        db.alter_column(u'sfpirgapp_project', 'project_subject_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Project.project_type_other'
        db.alter_column(u'sfpirgapp_project', 'project_type_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Project.project_subject_other'
        db.alter_column(u'sfpirgapp_project', 'project_subject_other', self.gf('django.db.models.fields.CharField')(default='blah', max_length=255))

        # Changing field 'Project.project_type_other'
        db.alter_column(u'sfpirgapp_project', 'project_type_other', self.gf('django.db.models.fields.CharField')(default='blah', max_length=255))
