...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Testimonial.author_full_name'
        db.add_column(u'sfpirgapp_testimonial', 'author_full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Testimonial.author_title'
        db.add_column(u'sfpirgapp_testimonial', 'author_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Testimonial.author_full_name'
        db.delete_column(u'sfpirgapp_testimonial', 'author_full_name')

        # Deleting field 'Testimonial.author_title'
        db.delete_column(u'sfpirgapp_testimonial', 'author_title')


        # Changing field 'Testimonial.user'
        db.alter_column(u'sfpirgapp_testimonial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
