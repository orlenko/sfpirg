...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.is_published'
        db.alter_column(u'sfpirgapp_project', 'is_published', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'Application.user'
        db.delete_column(u'sfpirgapp_application', 'user_id')

        # Adding field 'Application.email'
        db.add_column(u'sfpirgapp_application', 'email',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.is_published'
        db.alter_column(u'sfpirgapp_project', 'is_published', self.gf('django.db.models.fields.NullBooleanField')(null=True))
        # Adding field 'Application.user'
        db.add_column(u'sfpirgapp_application', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Application.email'
        db.delete_column(u'sfpirgapp_application', 'email')
