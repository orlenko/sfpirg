...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.featured_image'
        db.alter_column(u'sfpirgapp_category', 'featured_image', self.gf('sfpirgapp.fields.MyImageField')(max_length=255, null=True))

        # Changing field 'ActionGroup.featured_image'
        db.alter_column(u'sfpirgapp_actiongroup', 'featured_image', self.gf('sfpirgapp.fields.MyImageField')(max_length=255, null=True))

        # Changing field 'Testimonial.featured_image'
        db.alter_column(u'sfpirgapp_testimonial', 'featured_image', self.gf('sfpirgapp.fields.MyImageField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Category.featured_image'
        db.alter_column(u'sfpirgapp_category', 'featured_image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))

        # Changing field 'ActionGroup.featured_image'
        db.alter_column(u'sfpirgapp_actiongroup', 'featured_image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))

        # Changing field 'Testimonial.featured_image'
        db.alter_column(u'sfpirgapp_testimonial', 'featured_image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))
