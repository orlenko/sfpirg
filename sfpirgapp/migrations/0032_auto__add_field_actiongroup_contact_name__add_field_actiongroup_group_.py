...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionGroup.contact_name'
        db.add_column(u'sfpirgapp_actiongroup', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionGroup.group_email'
        db.add_column(u'sfpirgapp_actiongroup', 'group_email',
        ...
        # Adding field 'ActionGroup.goals'
        db.add_column(u'sfpirgapp_actiongroup', 'goals',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionGroup.timeline'
        db.add_column(u'sfpirgapp_actiongroup', 'timeline',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionGroup.oneliner'
        db.add_column(u'sfpirgapp_actiongroup', 'oneliner',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionGroup.twoliner'
        db.add_column(u'sfpirgapp_actiongroup', 'twoliner',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionGroup.potential_members'
        db.add_column(u'sfpirgapp_actiongroup', 'potential_members',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionGroup.contact_name'
        db.delete_column(u'sfpirgapp_actiongroup', 'contact_name')

        # Deleting field 'ActionGroup.group_email'
        db.delete_column(u'sfpirgapp_actiongroup', 'group_email')

        # Deleting field 'ActionGroup.basis_of_unity'
        db.delete_column(u'sfpirgapp_actiongroup', 'basis_of_unity')

        # Deleting field 'ActionGroup.goals'
        db.delete_column(u'sfpirgapp_actiongroup', 'goals')

        # Deleting field 'ActionGroup.timeline'
        db.delete_column(u'sfpirgapp_actiongroup', 'timeline')

        # Deleting field 'ActionGroup.oneliner'
        db.delete_column(u'sfpirgapp_actiongroup', 'oneliner')

        # Deleting field 'ActionGroup.twoliner'
        db.delete_column(u'sfpirgapp_actiongroup', 'twoliner')

        # Deleting field 'ActionGroup.potential_members'
        db.delete_column(u'sfpirgapp_actiongroup', 'potential_members')
    ...
    models = {
        ...
        u'sfpirgapp.testimonial': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'titles': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'testimonials'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'sites.site': {
