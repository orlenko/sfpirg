...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionGroupRequest.is_processed'
        db.add_column(u'sfpirgapp_actiongrouprequest', 'is_processed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionGroupRequest.is_processed'
        db.delete_column(u'sfpirgapp_actiongrouprequest', 'is_processed')
    ...
    models = {
        ...
        u'sfpirgapp.actiongrouprequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_processed': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
