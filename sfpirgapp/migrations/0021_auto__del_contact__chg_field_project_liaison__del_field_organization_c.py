...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'sfpirgapp_organization', 'contact_id')

        # Adding field 'Organization.contact_name'
        db.add_column(u'sfpirgapp_organization', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.contact_position'
        db.add_column(u'sfpirgapp_organization', 'contact_position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.contact_email'
        db.add_column(u'sfpirgapp_organization', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.contact_alt_email'
        db.add_column(u'sfpirgapp_organization', 'contact_alt_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.contact_phone'
        db.add_column(u'sfpirgapp_organization', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.liaison'
        db.alter_column(u'sfpirgapp_project', 'liaison_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sfpirgapp.Liaison']))
        # Adding field 'Organization.contact'
        db.add_column(u'sfpirgapp_organization', 'contact',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='organization', unique=True, to=orm['sfpirgapp.Contact']),
                      keep_default=False)

        # Deleting field 'Organization.contact_name'
        db.delete_column(u'sfpirgapp_organization', 'contact_name')

        # Deleting field 'Organization.contact_position'
        db.delete_column(u'sfpirgapp_organization', 'contact_position')

        # Deleting field 'Organization.contact_email'
        db.delete_column(u'sfpirgapp_organization', 'contact_email')

        # Deleting field 'Organization.contact_alt_email'
        db.delete_column(u'sfpirgapp_organization', 'contact_alt_email')

        # Deleting field 'Organization.contact_phone'
        db.delete_column(u'sfpirgapp_organization', 'contact_phone')
    ...
    models = {
        ...
        u'sfpirgapp.organization': {
            ...
            'contact_position': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
