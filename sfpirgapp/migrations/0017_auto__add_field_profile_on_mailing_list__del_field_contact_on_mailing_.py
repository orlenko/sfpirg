...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contact.on_mailing_list'
        db.delete_column(u'sfpirgapp_contact', 'on_mailing_list')

        # Adding field 'Contact.organization'
        db.add_column(u'sfpirgapp_contact', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='liaison_contacts', to=orm['sfpirgapp.Organization']),
                      keep_default=False)


        # Changing field 'Organization.contact'
        db.alter_column(u'sfpirgapp_organization', 'contact_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['sfpirgapp.Contact']))
        # Adding unique constraint on 'Organization', fields ['contact']
        db.create_unique(u'sfpirgapp_organization', ['contact_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Organization', fields ['contact']
        db.delete_unique(u'sfpirgapp_organization', ['contact_id'])

        # Deleting field 'Profile.on_mailing_list'
        db.delete_column(u'sfpirgapp_profile', 'on_mailing_list')

        # Adding field 'Contact.on_mailing_list'
        db.add_column(u'sfpirgapp_contact', 'on_mailing_list',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Contact.organization'
        db.delete_column(u'sfpirgapp_contact', 'organization_id')


        # Changing field 'Organization.contact'
        db.alter_column(u'sfpirgapp_organization', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sfpirgapp.Contact']))
    ...
    models = {
        ...
        u'sfpirgapp.contact': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'liaison_contacts'", 'to': u"orm['sfpirgapp.Organization']"}),
        ...
        u'sfpirgapp.liaison': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sfpirgapp.Organization']"})
        },
        u'sfpirgapp.organization': {
            'Meta': {'object_name': 'Organization'},
            'communities': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'contact': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'my_organization'", 'unique': 'True', 'to': u"orm['sfpirgapp.Contact']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'sfpirgapp.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
