...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sfpirgapp_project', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='arx_projects', to=orm['sfpirgapp.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.category'
        db.delete_column(u'sfpirgapp_project', 'category_id')
