...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActionGroupRequest.is_processed'
        db.alter_column(u'sfpirgapp_actiongrouprequest', 'is_processed', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'ActionGroupRequest.is_processed'
        db.alter_column(u'sfpirgapp_actiongrouprequest', 'is_processed', self.gf('django.db.models.fields.NullBooleanField')(null=True))
