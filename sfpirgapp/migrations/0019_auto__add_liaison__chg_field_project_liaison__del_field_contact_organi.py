...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Liaison'
        db.create_table(u'sfpirgapp_liaison', (
            ...
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='liaisons', to=orm['sfpirgapp.Organization'])),
        ))
        db.send_create_signal(u'sfpirgapp', ['Liaison'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'sfpirgapp_liaison')


        # Changing field 'Project.liaison'
        db.alter_column(u'sfpirgapp_project', 'liaison_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sfpirgapp.Contact']))
    ...
    models = {
        ...
        u'sfpirgapp.organization': {
            ...
            'contact': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'organization'", 'unique': 'True', 'to': u"orm['sfpirgapp.Contact']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'sfpirgapp.project': {
            ...
            'liaison': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sfpirgapp.Liaison']"}),
