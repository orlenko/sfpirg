...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sfpirgapp_address', 'street2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Address.street2'
        db.alter_column(u'sfpirgapp_address', 'street2', self.gf('django.db.models.fields.CharField')(default='-', max_length=255))
