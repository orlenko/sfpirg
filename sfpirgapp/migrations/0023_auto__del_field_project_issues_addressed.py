...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.issues_addressed'
        db.delete_column(u'sfpirgapp_project', 'issues_addressed')


    def backwards(self, orm):
        # Adding field 'Project.issues_addressed'
        db.add_column(u'sfpirgapp_project', 'issues_addressed',
