...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sfpirgapp_category', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='categorys', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.user'
        db.delete_column(u'sfpirgapp_category', 'user_id')
