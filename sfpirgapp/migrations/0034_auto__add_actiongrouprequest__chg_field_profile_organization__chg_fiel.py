...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionGroupRequest'
        db.create_table(u'sfpirgapp_actiongrouprequest', (
            ...
            ('group_email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('basis_of_unity', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('goals', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('timeline', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('oneliner', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('twoliner', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('potential_members', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('on_mailing_list', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'sfpirgapp', ['ActionGroupRequest'])


        # Changing field 'Profile.organization'
        db.alter_column(u'sfpirgapp_profile', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sfpirgapp.Organization'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Project.liaison'
        db.alter_column(u'sfpirgapp_project', 'liaison_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sfpirgapp.Liaison'], null=True, on_delete=models.SET_NULL))
        # Deleting field 'ActionGroup.basis_of_unity'
        db.delete_column(u'sfpirgapp_actiongroup', 'basis_of_unity')


        # Changing field 'Testimonial.user'
        db.alter_column(u'sfpirgapp_testimonial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'ActionGroupRequest'
        db.delete_table(u'sfpirgapp_actiongrouprequest')


        # Changing field 'Profile.organization'
        db.alter_column(u'sfpirgapp_profile', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sfpirgapp.Organization'], null=True))

        # Changing field 'Project.liaison'
        db.alter_column(u'sfpirgapp_project', 'liaison_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sfpirgapp.Liaison'], null=True))
        # Adding field 'ActionGroup.basis_of_unity'
        db.add_column(u'sfpirgapp_actiongroup', 'basis_of_unity',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Testimonial.user'
        db.alter_column(u'sfpirgapp_testimonial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
