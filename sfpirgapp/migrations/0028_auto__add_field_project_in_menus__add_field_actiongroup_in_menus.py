...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.in_menus'
        db.add_column(u'sfpirgapp_project', 'in_menus',
                      self.gf('mezzanine.pages.fields.MenusField')(default=(1, 2, 3, 4, 5), max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionGroup.in_menus'
        db.add_column(u'sfpirgapp_actiongroup', 'in_menus',
                      self.gf('mezzanine.pages.fields.MenusField')(default=(1, 2, 3, 4, 5), max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.in_menus'
        db.delete_column(u'sfpirgapp_project', 'in_menus')

        # Deleting field 'ActionGroup.in_menus'
        db.delete_column(u'sfpirgapp_actiongroup', 'in_menus')
