...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Testimonial.is_public'
        db.delete_column(u'sfpirgapp_testimonial', 'is_public')


    def backwards(self, orm):
        # Adding field 'Testimonial.is_public'
        db.add_column(u'sfpirgapp_testimonial', 'is_public',
