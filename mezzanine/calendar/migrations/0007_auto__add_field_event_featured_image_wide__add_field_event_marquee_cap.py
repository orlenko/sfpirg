...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.featured_image_wide'
        db.add_column(u'calendar_event', 'featured_image_wide',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.marquee_caption'
        db.add_column(u'calendar_event', 'marquee_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.featured_image_wide'
        db.delete_column(u'calendar_event', 'featured_image_wide')

        # Deleting field 'Event.marquee_caption'
        db.delete_column(u'calendar_event', 'marquee_caption')
